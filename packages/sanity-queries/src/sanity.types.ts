...
export type SignageDisplay = {
  ...
  showAnnouncementOverlay?: boolean;
  active?: boolean;
  notes?: string;
};
...
// Query: *[_type == "signageDisplay" && slug.current == $slug][0] {    _id,    name,    "slug": slug.current,    kind,    theme,    orientation,    dwellSeconds,    transition,    showClock,    showConferenceBranding,    showAnnouncementOverlay,    active,    lookaheadMinutes,    room->{      _id,      name,      "slug": slug.current    },    rooms[]->{      _id,      name,      "slug": slug.current    }  }
export type SIGNAGE_DISPLAY_QUERY_RESULT = {
  ...
  showAnnouncementOverlay: boolean | null;
  active: boolean | null;
