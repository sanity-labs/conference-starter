...
// Query: *[_type == "sponsor" && defined(logo)] | order(    select(      tier == "platinum" => 0,      tier == "gold" => 1,      tier == "silver" => 2,      tier == "bronze" => 3,      tier == "community" => 4,      5    ) asc,    order asc,    name asc  ) {    _id,    name,    tier,    logo { ..., alt },    website  }
...
// Query: *[_type == "conference"][0] {    _id,    name,    tagline,    description,    startDate,    endDate,    logo { ..., alt },    venue->{name, address},    "sponsors": *[_type == "sponsor" && defined(logo)] | order(      select(        tier == "platinum" => 0,        tier == "gold" => 1,        tier == "silver" => 2,        tier == "bronze" => 3,        tier == "community" => 4,        5      ) asc,      order asc    )[0...12] {      _id,      name,      tier,      logo { ..., alt }    }  }
