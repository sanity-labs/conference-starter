...
export type AnnouncementMode = 'none' | 'banner' | 'takeover'

export async function AnnouncementOverlay({mode}: {mode: AnnouncementMode}) {
  ...
  return <AnnouncementOverlayClient announcement={latest} mode={mode} />
}
